console.log("combined7.js is loading");
// Select the link element for the stylesheet
const stylesheet = document.querySelector('link[href="file:///Users/ezgranet/Desktop/lsb/lsb.css"]');



document.addEventListener("DOMContentLoaded", function () {
        console.log("Positioning sidenotes after stylesheet is loaded...");
    ...
    if (sidenotesContainer) {
        ...
        console.log(`Found ${footnoteSpans.length} footnote spans`);
        ...
        footnoteSpans.forEach((span, index) => {
            ...
            if (footnoteLabel) {
                ...
                console.log(`Positioned sidenote ${index + 1}`);
            } else {
